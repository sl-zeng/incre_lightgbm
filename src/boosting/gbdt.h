...
class GBDT : public GBDTBase {
  ...
  */
  void MergeFrom(const Boosting* other) override {
    ...
    std::cout << "from MergeFrom: other_tree_num =" << i << std::endl;
    i = 0;
    ...
    std::cout << "from MergeFrom: original_tree_num =" << i << std::endl;
  ...
  */
  ...
  void MyTrain(int snapshot_freq, const std::string& model_output_path, const std::string& input_model_path, int num_iterations, int erase_pos) override;
